...
KERNEL_SOURCES = $(call rwildcard,kernel,*.c) $(call rwildcard,drivers,*.c) $(call rwildcard,std,*.c)
HEADERS = $(call rwildcard,includes,*.h) $(call rwildcard,drivers,*.h) $(call rwildcard,std,*.h)
